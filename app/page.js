...
export default function Home() {
  ...
  return (
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-950 via-slate-900 to-slate-950 text-white">
      ...
      <div className="max-w-7xl mx-auto px-4 py-6 flex gap-6">
        ...
        <main className="flex-1 min-w-0">
          <div className="mb-8 bg-gradient-to-r from-cyan-500/10 to-blue-500/10 border border-cyan-500/20 rounded-2xl p-8">
            ...
            <p className="text-slate-300 text-lg mb-6">
              Fastest AI inference. Voice input/output. Image, Video, Chat - All in one
            </p>
            <button
              onClick={() => setChatOpen(true)}
      ...
      {/* CHAT MODAL WITH GROQ */}
      {chatOpen && (
        <div className="fixed inset-0 bg-black/70 backdrop-blur-sm z-50 flex items-center justify-center p-4">
          <div className="bg-slate-900 border border-cyan-500/30 rounded-2xl w-full max-w-2xl h-[80vh] flex flex-col">
